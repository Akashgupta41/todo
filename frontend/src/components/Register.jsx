    ...
    <div>
      ...
      <div className="w-full h-screen flex items-center justify-center">
        <form
          ...
          className="w-[50%] flex items-center flex-col  border-2 border-gray-600 bg-cyan-800 text-white rounded-xl p-40 pt-20"
        >
          ...
          <div className="flex">
            ...
            <Link to={"/login"}>
              <h1 className="text-blue-500">Login Now</h1>
            </Link>
          </div>
          <button
            className="bg-white w-56 h-15 p-2 text-black rounded-full m-8 "
            type="submit"
          >
            Register
          </button>
